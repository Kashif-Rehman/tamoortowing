...
export default function Header() {
  ...
  const seo = {
    ar: {
      title: "سطحة الخبر | سطحة هيدروليك الخبر | نقل سيارات للبحرين | " + PHONE_DISPLAY + " | سحب سيارات 24 ساعة",
    ...
    en: {
      title: "Tow Truck Khobar | Vehicle Transport to Bahrain | Hydraulic Flatbed | " + PHONE_DISPLAY + " | 24/7 Service",
