...
export default function Logo({ size = 60, variant = 'full', className = '' }) {
  ...
  return (
    ...
    >
      ...
      {/* Icon circle */}
      <circle cx="60" cy="60" r="52" fill="url(#logoGrad)" />
      <circle cx="60" cy="60" r="48" fill="none" stroke="#D4AF37" strokeWidth="2" />

      {/* Truck icon in circle */}
      <g transform="translate(25, 32)" fill="#D4AF37">
      ...
      {/* Gold accent line */}
      <line x1="125" y1="56" x2="350" y2="56" stroke="url(#goldGrad)" strokeWidth="1.5" opacity="0.6" />
    </svg>
  );
}
