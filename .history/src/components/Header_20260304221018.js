...
export default function Header() {
  ...
  const seo = {
    ar: {
      ...
      description: "سطحة هيدروليك الخبر - أفضل خدمة سطحة وسحب سيارات في الخبر والدمام والظهران والمنطقة الشرقية. سطحة هيدروليك حديثة، استجابة خلال 10 دقائق، أسعار مناسبة. اتصل الآن " + PHONE_DISPLAY,
      keywords: "سطحة الخبر, سطحة هيدروليك الخبر, سطحة الدمام, سطحة الظهران, سحب سيارات الخبر, سطحة هيدروليك, نقل سيارات الخبر, سطحة طوارئ الخبر, سطحة رخيصة الخبر, سطحة 24 ساعة الخبر, سطحة العزيزية, سطحة الثقبة, سطحة الجبيل, سطحة القطيف, سطحة رأس تنورة, سحب سيارات الدمام, سحب سيارات الظهران, سطحة هيدروليك الدمام, ونش الخبر, ونش سحب الخبر, سطحة نقل سيارات, سطحة فوق, سطحة تحت, سطحة هيدرولك الدمام, خدمة سطحة المنطقة الشرقية, أرخص سطحة بالخبر, أفضل سطحة بالخبر, satah alkhobar, towing khobar",
      url: DOMAIN,
      image: OG_IMAGE,
      locale: "ar_SA",
    },
    en: {
      ...
      description: "Al Khobar Hydraulic Towing - Professional 24/7 flatbed towing and vehicle recovery in Khobar, Dammam, Dhahran & Eastern Province. Fast 10-min response, affordable rates. Call " + PHONE_DISPLAY,
      keywords: "tow truck Khobar, towing Khobar, flatbed towing Khobar, سطحة الخبر, vehicle recovery Khobar, towing Dammam, towing Dhahran, emergency towing Khobar, car towing Eastern Province, hydraulic towing Saudi Arabia, Khobar tow truck service, 24/7 towing Khobar, affordable towing Khobar, satah alkhobar, satah al khobar",
      url: DOMAIN,
      image: OG_IMAGE,
      locale: "en_US",
    }
