...
const EMAIL = "tamoorch900@gmail.com";
...
export default function Header() {
  ...
  const seo = {
    ar: {
      title: "سطحة الخبر | سطحة هيدروليك الخبر | سحب البحرين | " + PHONE_DISPLAY + " | سحب سيارات 24 ساعة",
      description: "سطحة هيدروليك الخبر - أفضل خدمة سطحة وسحب سيارات في الخبر والدمام والظهران. سحب دولي إلى البحرين عبر جسر الملك فهد وحدود الكويت والإمارات. استجابة 10 دقائق، أسعار مناسبة. اتصل الآن " + PHONE_DISPLAY,
      keywords: "سطحة الخبر, سطحة هيدروليك الخبر, سطحة الدمام, سطحة الظهران, سحب سيارات الخبر, سطحة هيدروليك, نقل سيارات الخبر, سطحة طوارئ الخبر, سطحة رخيصة الخبر, سطحة 24 ساعة الخبر, سطحة العزيزية, سطحة الثقبة, سطحة الجبيل, سطحة القطيف, سطحة رأس تنورة, سحب سيارات الدمام, سحب سيارات الظهران, سطحة هيدروليك الدمام, ونش الخبر, ونش سحب الخبر, سطحة نقل سيارات, سطحة البحرين, سحب سيارات البحرين, سطحة جسر الملك فهد, سحب دولي الخبر, سطحة الخفجي, سحب حدود الكويت, سحب حدود الإمارات, سحب حدود عمان, satah alkhobar, towing khobar, towing bahrain",
      url: DOMAIN,
      image: OG_IMAGE,
      locale: "ar_SA",
    },
    en: {
      title: "Tow Truck Khobar | Bahrain Towing | Hydraulic Flatbed | " + PHONE_DISPLAY + " | 24/7 Service",
      description: "Al Khobar Hydraulic Towing - Professional 24/7 flatbed towing in Khobar, Dammam, Dhahran. International towing to Bahrain via King Fahd Causeway + Kuwait, UAE & Oman borders. Fast 10-min response. Call " + PHONE_DISPLAY,
      keywords: "tow truck Khobar, towing Khobar, flatbed towing Khobar, سطحة الخبر, vehicle recovery Khobar, towing Dammam, towing Dhahran, emergency towing Khobar, car towing Eastern Province, hydraulic towing Saudi Arabia, Khobar tow truck service, 24/7 towing Khobar, affordable towing Khobar, towing to Bahrain, Bahrain tow truck, King Fahd Causeway towing, international towing Khobar, cross border towing Saudi, towing Kuwait border Khafji, towing UAE border, satah alkhobar, satah al khobar",
      url: DOMAIN,
      image: OG_IMAGE,
      locale: "en_US",
    }
  ...
  const structuredData = {
    ...
    "slogan": "سطحة هيدروليك الخبر - خدمة سحب سيارات سريعة وموثوقة",
  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.overlay}>
        <Logo size={55} variant="full" className={styles.headerLogo} />
